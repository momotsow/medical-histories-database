...
**[Medical Histories Database]** is a database model created from a given schema diagram. We solve many to many relations using treatment_histories table as pivot.
...
- **[Schema creation]** Using SQL for Postgres.
...
sh
cd my-folder
git@github.com:momotsow/medical-histories-database.git
